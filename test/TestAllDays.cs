...
namespace test
{
    ...
    {
        [Fact]
        public static void Example() => Assert.Equal((0, 0), aoc.Day09.DoPuzzle(Input.example));
        [Fact]
        public static void Test() => Assert.Equal((0, 0), aoc.Day09.DoPuzzle(Input.actual));
    }
    ...
    {
        [Fact]
        public static void Example() => Assert.Equal((0, 0), aoc.Day13.DoPuzzle(Input.example));
        [Fact]
        public static void Test() => Assert.Equal((0, 0), aoc.Day13.DoPuzzle(Input.actual));
    }
    public class TestDay14
    {
        [Fact]
        public static void Example() => Assert.Equal((0, 0), aoc.Day14.DoPuzzle(Input.example));
        [Fact]
        public static void Test() => Assert.Equal((0, 0), aoc.Day14.DoPuzzle(Input.actual));
    }
